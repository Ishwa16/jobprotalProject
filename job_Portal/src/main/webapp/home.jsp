            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <form class="form-inline" action="more_view.jsp" method="get">
                            ...
                            <div class="form-group col-md-5">
                                <select class="custom-select" id="inlineFormCustomselectref" name="cat">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        ...
                        <h6><%= j.getTitle() %></h6>
                        <%
                            if (j.getDesciption().length() > 0 && j.getDesciption().length() < 120) {
                        %>
                        <p><%= j.getDesciption() %>.</p>
                        <%
                            } else {
                        %>
                        <p><%= j.getDesciption().substring(0, 120) %>...</p>
                        <%
                            }
                        %>
                        <br>
                        ...
                        <div class="text-center">
                            ...
                            <a href="apply.jsp" class="btn btn-sm btn-primary apply-button">Apply</a>
                        </div>
                    </div>
                </div>
                <%
